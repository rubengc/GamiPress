...
// Register the plural separately to keep backward compatibility
add_shortcode( 'gamipress_last_achievements_earned', 'gamipress_last_achievements_earned_shortcode' );
