...
function gamipress_register_achievement_types() {
	...
	foreach ( $achievement_types as $achievement_type ) {
		...
		$post_type_args = array(
			...
			'show_in_rest'       => apply_filters( "gamipress_show_achievement_{$achievement_slug}_in_rest", true ),
			'query_var'          => true,
...
function gamipress_register_rank_types() {
	...
	foreach ( $rank_types as $rank_type ) {
		...
		$post_type_args = array(
			...
			'show_in_rest'       => apply_filters( "gamipress_show_rank_{$rank_slug}_in_rest", true ),
			'query_var'          => true,
