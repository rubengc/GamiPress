...
$('.export-setup-button').prop('disabled',!0);$('.export-setup-button').parent().parent().prepend('<span id="export-setup-response"><span class="spinner is-active" style="float: none;"></span></span>');var items=[];$('.cmb2-id-export-setup-options input:checked').each(function(){items.push($(this).val())});$.post(ajaxurl,{action:'gamipress_export_setup_tool',items:items},function(response){if(response.success===!1){$('#export-setup-response').css({color:'#a00'})}
