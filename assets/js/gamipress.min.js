...
gamipress_unlock_achievement_with_points(submit_wrap);else gamipress_unlock_rank_with_points(submit_wrap)});$body.on('click','.gamipress-achievement-unlock-with-points-cancel-button, .gamipress-rank-unlock-with-points-cancel-button',function(e){var $this=$(this);var selector=($this.hasClass('gamipress-achievement-unlock-with-points-cancel-button')?'achievement':'rank');var submit_wrap=$this.closest('.gamipress-'+selector+'-unlock-with-points');var button=submit_wrap.find('.gamipress-'+selector+'-unlock-with-points-button');var confirmation=submit_wrap.find('.gamipress-'+selector+'-unlock-with-points-confirmation');confirmation.slideUp();button.prop('disabled',!1)});$body.on('click','#gamipress-logs-pagination a',function(e){e.preventDefault();var $this=$(this);if($this.hasClass('current')){return!1}
