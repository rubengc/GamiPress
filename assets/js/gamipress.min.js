(function($){var $body=$('body');function gamipress_ajax_achievement_list(achievement_list){achievement_list.find('.gamipress-spinner').show();$.ajax({url:gamipress.ajaxurl,data:{action:'gamipress_get_achievements',type:achievement_list.find('input[type="hidden"][name="type"]').val(),limit:achievement_list.find('input[type="hidden"][name="limit"]').val(),show_parent:achievement_list.find('input[type="hidden"][name="show_parent"]').val(),show_child:achievement_list.find('input[type="hidden"][name="show_child"]').val(),group_id:achievement_list.find('input[type="hidden"][name="group_id"]').val(),user_id:achievement_list.find('input[type="hidden"][name="user_id"]').val(),wpms:achievement_list.find('input[type="hidden"][name="wpms"]').val(),offset:achievement_list.find('#gamipress_achievements_offset').val(),count:achievement_list.find('#gamipress_achievements_count').val(),filter:((achievement_list.find('#achievements_list_filter').length)?achievement_list.find('#achievements_list_filter').val():''),search:achievement_list.find('#achievements_list_search').val(),orderby:achievement_list.find('input[type="hidden"][name="orderby"]').val(),order:achievement_list.find('input[type="hidden"][name="order"]').val(),include:achievement_list.find('input[type="hidden"][name="include"]').val(),exclude:achievement_list.find('input[type="hidden"][name="exclude"]').val(),meta_key:achievement_list.find('input[type="hidden"][name="meta_key"]').val(),meta_value:achievement_list.find('input[type="hidden"][name="meta_value"]').val()},dataType:'json',success:function(response){achievement_list.find('.gamipress-spinner').hide();if(response.data.message===null){}else{achievement_list.find('#gamipress-achievements-container').append(response.data.message);achievement_list.find('#gamipress_achievements_offset').val(response.data.offset);achievement_list.find('#gamipress_achievements_count').val(response.data.achievement_count);if(response.data.query_count<=response.data.achievement_count){achievement_list.find('#achievements_list_load_more').hide()}
else{achievement_list.find('#achievements_list_load_more').show()}}}})}
