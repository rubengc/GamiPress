...
var trigger_type=$(this).val();var points_selector_required=$(this).siblings('.points-required');var points_type_selector_required=$(this).siblings('.select-points-type-required');if(trigger_type==='earn-points'){points_selector_required.show();points_type_selector_required.show()}else{points_selector_required.hide();points_type_selector_required.hide()}
