...
var trigger_type=$(this).val();var achievement_type_selector=$(this).siblings('.select-achievement-type');var achievement_post_selector=$(this).siblings('.select-achievement-post');if(trigger_type==='any-achievement'||trigger_type==='all-achievements'||trigger_type==='specific-achievement'){achievement_type_selector.show();achievement_type_selector.change()}else{achievement_type_selector.hide();achievement_post_selector.hide()}
