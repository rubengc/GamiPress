...
function shouldAdjustOldDeltas(orgEvent,absDelta){return special.settings.adjustOldDeltas&&orgEvent.type==='mousewheel'&&absDelta%120===0}}));S2.define('jquery.select2',['jquery','jquery-mousewheel','./select2/core','./select2/defaults','./select2/utils'],function($,_,Select2,Defaults,Utils){if($.fn.gamipress_select2==null){var thisMethods=['open','close','destroy'];$.fn.gamipress_select2=function(options){options=options||{};if(typeof options==='object'){this.each(function(){var instanceOptions=$.extend(!0,{},options);var instance=new Select2($(this),instanceOptions)});return this}else if(typeof options==='string'){var ret;var args=Array.prototype.slice.call(arguments,1);this.each(function(){var instance=Utils.GetData(this,'select2');if(instance==null&&window.console&&console.error){console.error('The select2(\''+options+'\') method was called on an '+'element that is not using Select2.')}
ret=instance[options].apply(instance,args)});if($.inArray(options,thisMethods)>-1){return this}
return ret}else{throw new Error('Invalid arguments for Select2: '+options)}}}
if($.fn.select2!=null&&$.fn.select2.defaults!=null)
$.fn.gamipress_select2.defaults=$.fn.select2.defaults;if($.fn.gamipress_select2.defaults==null)
$.fn.gamipress_select2.defaults=Defaults;$.fn.select2=$.fn.select2||$.fn.gamipress_select2;return Select2});return{define:S2.define,require:S2.require}}());var select2=S2.require('jquery.select2');jQuery.fn.select2.amd=S2;jQuery.fn.gamipress_select2.amd=S2;return select2}))