	...
	function gamipress_ajax_achievement_list( achievement_list ) {
		...
		$.ajax( {
			...
			data : {
				...
				show_parent : achievement_list.find('input[type="hidden"][name="show_parent"]').val(),
				show_child : achievement_list.find('input[type="hidden"][name="show_child"]').val(),
				group_id : achievement_list.find('input[type="hidden"][name="group_id"]').val(),
