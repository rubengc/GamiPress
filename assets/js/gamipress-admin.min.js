...
$('#slug-warning').remove();if(slug.length>20){field.css({'background':'#faa','color':'#a00','border-color':'#a55'});field.parent().append('<span id="slug-warning" class="cmb2-metabox-description" style="color: #a00;">'+label+'\'s slug supports a maximum of 20 characters.</span>')}else{field.css({'background':'','color':'','border-color':''})}});$('.gamipress-form input#post_name').trigger('keyup');$('.gamipress_settings #automatic_updates').change(function(){var target=$('.cmb2-id-automatic-updates-plugins');if(target.length){if($(this).prop('checked')){target.slideDown()}else{target.slideUp()}}});if(!$('.gamipress_settings #automatic_updates').prop('checked')){$('.cmb2-id-automatic-updates-plugins').hide()}
