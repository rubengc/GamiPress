...
target.removeClass('cmb2-tab-ignore')}}).change();$('#gamipress_points_period').change(function(){var target=$(this).closest('.cmb2-wrap').find('.cmb2-id-gamipress-points-period-start, '+'.cmb2-id-gamipress-points-period-end');if($(this).val()!=='custom'){target.slideUp().addClass('cmb2-tab-ignore')}else{target.slideDown().removeClass('cmb2-tab-ignore')}}).change();$('#gamipress_points_inline').change(function(){var target=$(this).closest('.cmb2-wrap').find('.cmb2-id-gamipress-points-columns, '+'.cmb2-id-gamipress-points-layout');if($(this).prop('checked')){target.slideUp().addClass('cmb2-tab-ignore')}else{target.slideDown().removeClass('cmb2-tab-ignore')}});$('body').on('gamipress_shortcode_attributes','#gamipress_points_wrapper',function(e,args){if(args.attributes.inline==='yes'){delete args.attributes.columns;delete args.attributes.layout}});$('#gamipress_earnings_points, #gamipress_earnings_achievements, #gamipress_earnings_ranks').change(function(){var id=$(this).attr('id');var target=undefined;if(id==='gamipress_earnings_points'){target=$('.cmb2-id-gamipress-earnings-points-types, .cmb2-id-gamipress-earnings-awards, .cmb2-id-gamipress-earnings-deducts')}else if(id==='gamipress_earnings_achievements'){target=$('.cmb2-id-gamipress-earnings-achievement-types, .cmb2-id-gamipress-earnings-steps')}else if(id==='gamipress_earnings_ranks'){target=$('.cmb2-id-gamipress-earnings-rank-types, .cmb2-id-gamipress-earnings-rank-requirements')}
